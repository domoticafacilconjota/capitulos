...
if (isset($_REQUEST['minimal_firmware_path']) && !empty($_REQUEST['minimal_firmware_path'])) {
    if (file_exists("data/firmwares/tasmota-minimal.bin.gz"))
        $ota_minimal_firmware_url = $otaServer . "data/firmwares/tasmota-minimal.bin.gz";
    else
        $ota_minimal_firmware_url = $otaServer . "data/firmwares/tasmota-minimal.bin";

}

if (file_exists("data/firmwares/tasmota.bin.gz"))
    $ota_new_firmware_url = $otaServer . "data/firmwares/tasmota.bin.gz";
else
